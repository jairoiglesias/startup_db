...
int FreeCredencialsHandleError = 0;
...
SecurityCredentials::~SecurityCredentials() {
  ...
  // printf("SecurityCredentials::~SecurityCredentials started\n");

  // if(&this->m_Credentials != NULL) {

  //   if(SecIsValidHandle(&this->m_Credentials)){
    
  //     if(_sspi_FreeCredentialsHandle(&this->m_Credentials) == -2){
  //       FreeCredencialsHandleError = 1;
  //     }
  //   }
  //   else{
  //     printf("SecurityCredentials: Not is a Valid Handler!\n");
  //   }
...
NAN_METHOD(SecurityCredentials::New) {
  ...
  printf("SecurityCredentials::New Started !!!\n");
...
static void _noProcess(Worker *worker){

}

// ### Esta função irá ser processado pelo Worker via LIB_UV_QUEUE ###
...
NAN_METHOD(SecurityCredentials::Acquire) {
  ...
  if(FreeCredencialsHandleError == 0){
  ...
  else if(FreeCredencialsHandleError == 1){

    printf("Error in FreeCredentialsHandler !!!\n");
    ...
    worker->callback = callback;
    worker->error_code = -2;
    worker->error_message = "Free Credentials Handler Failed!";
    worker->execute = _noProcess;
    worker->mapper = _map_authSSPIAquire;
...
// ### Funções Callback dos workers que estão na LIB_UV_QUEUE ###
